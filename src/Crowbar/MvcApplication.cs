...
namespace Crowbar
{
    ...
    public class MvcApplication
    {
        ...
        {
            return MvcApplicationFactory.Create(new WebProjectPathProvider(name), new WebConfigPathProvider(config), defaults);
        }
        ...
        {
            return MvcApplicationFactory.Create<TProxy, TContext>(new WebProjectPathProvider(name), new WebConfigPathProvider(config), defaults);
        }
    }
