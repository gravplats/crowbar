...
namespace Crowbar
{
    ...
    public class MvcApplication
    {
        ...
        public static MvcApplication Create(string name, string config = "Web.config", IHttpPayloadDefaults defaults = null)
        {
        ...
        /// <param name="defaults">Default HTTP payload settings, if any.</param>
        /// <returns>An MVC application.</returns>
        public static MvcApplication<THttpApplication> Create<THttpApplication>(string name, string config = "Web.config", IHttpPayloadDefaults defaults = null)
        ...
        /// <param name="defaults">Default HTTP payload settings, if any.</param>
        /// <returns>An MVC application.</returns>
        public static MvcApplication<THttpApplication, TContext> Create<THttpApplication, TProxy, TContext>(string name, string config = "Web.config", IHttpPayloadDefaults defaults = null)
            where THttpApplication : HttpApplication
